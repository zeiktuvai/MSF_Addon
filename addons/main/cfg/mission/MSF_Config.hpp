class MSFConfig
{
	class InventorySets
	{
		items[] = {"ACE_DefusalKit", "ACE_CableTie", "ToolKit", "ACE_UAVBattery", "ACE_wirecutter", "ACE_IR_Strobe_Item", "ACE_Yardage450"};
