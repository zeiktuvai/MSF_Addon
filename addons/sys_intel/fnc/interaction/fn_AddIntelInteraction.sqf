...
private _showCondition = "!(_target getVariable ['MSF_Intel_Activated', false]) && [_target] call ace_medical_status_fnc_isInStableCondition";
...
if ("ThingX" in _parents) then {
	_prompt = "Search for Intel";
	_showCondition = "!(_target getVariable ['MSF_Intel_Activated', false])";
