...
[_area select 0, _area select 1, _height, _position, [[_activationSide] call MSF_fnc_GetModuleActivationSide, "present"], ["this",
	...
	[[_side] call BIS_fnc_sideType, _building, _bldgStr, _bldgProb, _vehicle, _vicNum, _vicFill, _vicProb, _armor, _armorNum, _armorProb, _static, _staticNum, _staticProb, _air, _airNum, _airProb, _area, [_intelP, _interactC, _intelC]],
	true
