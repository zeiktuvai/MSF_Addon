...
private MSF_ifnc_AddRandomItem =
{
	params ["_category", "_object", "_inv"];
	switch (_category) do {
		case 0: { _object addMagazineCargoGlobal [selectRandom _inv select 1, 1];};
		case 1: { _object addMagazineCargoGlobal [selectRandom _inv select 2, 1];};
		case 2: { _object addMagazineCargoGlobal [selectRandom _inv select 3, 1];};
		case 3: { _object addItemCargoGlobal [selectRandom _inv select 4, 1];};
		case 4: { _object addItemCargoGlobal [selectRandom _inv select 5, 1];};
	};
};
