...
[_logic, _area select 0, _area select 1, [_activationSide] call MSF_fnc_GetModuleActivationSide, "present", _area select 3, _allObjs, "POI", createHashMap, _intelID] call MSF_Loc_fnc_CreateLocationActivationTrigger;
