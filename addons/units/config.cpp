...
class CfgPatches
{
    class MSF3den
    {
        ...
        units[] = {
            ...
            "MSF_mc_BaseBackpack", "MSF_mc_MarksmanBackpack", "MSF_mc_PMAGBackpack", "MSF_mc_PMAGSupplyBackpack",
            "MSF_mc_SniperBackpack", "MSF_mc_ATBackpack", "MSF_mc_AABackpack", "MSF_mc_MedicBackpack", "MSF_mc_EngBackpack",
            "MSF_mc_MineBackpack"
        };
        weapons[] = {};
        requiredVersion = 2.0;
