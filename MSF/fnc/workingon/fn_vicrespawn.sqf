// Implement this so it's a check box and interfaces with persistence
// If checked it makes the vehicle look like it did on respawn.
// If inv gen is on then execute that as well.
// If persist is on and this vehicle type is in it, then add checkbox to enable restore from persist data
